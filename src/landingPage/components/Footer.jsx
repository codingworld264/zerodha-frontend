          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <form className="d-flex">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="#">NSE</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">BSE</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">MCX</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">Terms & conditions</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">Policies & procedures</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">Privacy Policy</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">Disclosure</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">For investor's attention</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="#">Investor charter</Link>
              </li>
